...
tree = read.newick(paste("2_no_clades_labels/phylipFor.phy_phyml_tree.txt", sep = ""),
                   node.label = "support")
...
phylogroup = read.table(paste("2_no_clades_labels/phylogeny_list.txt", sep = ""),
...
geneMatches=read.table(paste("2_no_clades_labels/geneMatches.txt", sep=""),
                       col.names = c("gene","label"))
genes = read.table(paste("2_no_clades_labels/genesOI.txt", sep=""))
...
genomes_added_in = read.table(paste("2_no_clades_labels//genomes.added.txt", sep=""), 
                              col.names = c("genomes"))
...
if (do_you_want_pgroup_labels == "yes"){
  ...
  save_plot(plot_heatmap, 1500, 1500, paste("files_to_share/output/finalPlot.EMF", sep =""))
}
...
if (do_you_want_pgroup_labels == "no"){
  ...
  #And finally saving that plot.
  save_plot(plot_heatmap, 1500, 1500, paste("2_no_clades_labels/finalPlot.EMF", sep =""))
}
